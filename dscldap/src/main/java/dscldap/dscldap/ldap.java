...
public class ldap implements Callable{
@Override
    public Object onCall(MuleEventContext eventContext) throws Exception {
           JSONObject inputJsonObj =  new JSONObject (eventContext.getMessage().getPayload().toString());
          String str=eventContext.getMessage().getPayload().toString() +" this is get message getpayload";
